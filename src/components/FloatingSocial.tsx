...
export default function FloatingSocial() {
  return (
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40 flex flex-col shadow-lg rounded-l-2xl overflow-hidden">
      {socials.map((s) => (
        <a
          key={s.label}
          href={s.href}
          ...
          aria-label={s.label}
          className="bg-white/90 backdrop-blur-sm text-ink-muted hover:bg-terracotta hover:text-cream transition-all duration-200 w-11 h-11 flex items-center justify-center border-b border-cream-border last:border-0"
        >
          {s.icon}
        </a>
      ))}
